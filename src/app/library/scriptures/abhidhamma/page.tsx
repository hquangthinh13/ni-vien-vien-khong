...
export default async function AbhidhammaListPage({
  ...
  return (
    <PageShell>
      <AppBreadcrumb locale={locale} items={[{ label: locale === "vi" ? "Thư viện" : "Library" }, { label: locale === "vi" ? "Tạng Vi Diệu Pháp" : "Abhidhamma Texts" }]} />
      <PageHeader
        title={locale === "vi" ? "Tạng Vi Diệu Pháp" : "Abhidhamma Texts"}
      />
