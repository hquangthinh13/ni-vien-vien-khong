...
export default async function FirstPatriarchListPage({
  ...
  return (
    <PageShell>
      <AppBreadcrumb locale={locale} items={[{ label: locale === "vi" ? "Thư viện" : "Library" }, { label: locale === "vi" ? "Sách Sơ Tổ Hộ Tông" : "First Patriarch Books" }]} />
      <PageHeader
        title={locale === "vi" ? "Sách Sơ Tổ Hộ Tông" : "First Patriarch Books"}
      />
